             ...
             <div class="modal-content modal-content-custom">
                 ...
                 <div class="modal-body modal-body-custom">
                     <ul class="nav nav-tabs" role="tablist">
                         <li class="nav-item">
                             <a class="nav-link active show" id="product-tab" data-toggle="tab" href="#product-1" role="tab" aria-controls="product-1" aria-selected="true">Product</a>
                         </li>
                         <li class="nav-item">
                             <a class="nav-link" id="price-tab" data-toggle="tab" href="#price-1" role="tab" aria-controls="price-1" aria-selected="false">Price</a>
                         </li>
                     </ul>
                     <div class="tab-content" id="nav-tabContent">
                         ...
                         <div class="tab-pane fade" id="price-1" role="tabpanel" aria-labelledby="price-tab">
                             <div class="row">
                                 <div class="col-md-12">
                                     <button onclick="CrudPrice('Create','*')" type="button" class="btn btn-sm btn-primary">Add Price <i class=" fa fa-plus-circle"></i></button>
